...
@section('footer_import')
  ...
  <script>
	...
	*******************/-->
	...
	<script>
		$(document).ready(function() {
			airWindows('elements_ctn', {ajaxpath:'ajax_obj', objpath:'', ajaxobj:'modules', ajaxact:'generateform', parent : {{$moduleinfo['id']}}},'','Test',false);
...
<input type="hidden" name="md_id" id="md_id" value="{{ $moduleinfo['id'] ?? '' }}">						
								
<div class="row">
	@php $col = 'col-xs-12 col-sm-12 col-lg-12'; @endphp
	@if($moduleinfo['setting']=='yes' || $moduleinfo['acategory']=='yes')
		@php $col = 'col-xs-12 col-sm-9 col-lg-10'; @endphp
	@endif
	<div class="{{$col}}">
		...
		<div class="tabbable">
											<ul class="nav nav-tabs" id="myTab">
												...
												@php ($active = 'active') @endphp
														@foreach (config('ccms.multilang') as $lang)
															<li class="{{$active}}">
																<a data-toggle="tab" href="#{{$lang[0]}}" aria-expanded="false">
																	@lang('ccms.'.$lang[0])
																</a>
															</li>
															@php ($active = '') @endphp
											...
											<div class="tab-content">
												...
												@foreach (config('ccms.multilang') as $lang)
													<div id="{{$lang[0]}}" class="tab-pane fade {{$active}}">
															...
															<div class="col-xs-12 col-sm-12 col-lg-12">
																...
																@php
																	$des_default='<div class="row">
																		...
																		$des=isset(${'des-'.$lang[0]})?${'des-'.$lang[0]}:$des_default;
																@endphp
														...
														<div class="row">
														  ...
														  <div class="col-xs-12 col-sm-12 col-lg-6 form-group">
															...
															<input class="form-control input-sm" type="text" name="metatitle-{{$lang[0]}}" id="metatitle-{{$lang[0]}}"   value="{{ ${'metatitle-'.$lang[0]} or '' }}"/>
														  </div>
														  
														 <div class="col-xs-12 col-sm-12 col-lg-6 form-group">
															<label class="frm-label" for="metakeyword-{{$lang[0]}}">Meta Keyword (seperate by comma)</label>
															<input class="form-control input-sm" type="text" name="metakeyword-{{$lang[0]}}" id="metakeyword-{{$lang[0]}}" value="{{ ${'metakeyword-'.$lang[0]} or '' }}"/>
														  </div>
														  
														  <div class="col-xs-12 col-sm-12 col-lg-12 form-group">
															<label class="frm-label" for="metades-{{$lang[0]}}">Meta Description (maximum of 160 chars)</label>
															<input class="form-control input-sm" type="text" name="metades-{{$lang[0]}}" id="metades-{{$lang[0]}}" value="{{ ${'metades-'.$lang[0]} or '' }}"/>
														  </div>
		...
		<div id="elements_ctn" class="tab-content">
												...
												<div class="panel-collapse collapse in" id="collapseOne">
													<div class="panel-body">
														<div class="row">
															...
															<div class="col-sm-12 form-group">
																<label class="frm-label" for="inquiry">Order</label>
																	...
																	<div class="input-group">
																		<input type="text" name="ordering" id="ordering" class="spinbox-input form-control input-sm text-center"​ value="{{$ordering or ''}}">
															...
															<br />
															<div class="input-group">
																	<input class="form-control input-sm date-picker" name="add_date" id="add_date" type="text" data-date-format="dd-mm-yyyy" value="{{$add_date or ''}}">
															...
															<div class="col-sm-12 form-group">
																...
																<br />
																<div class="input-group">
																		<input class="form-control input-sm date-picker" name="exp_date" id="exp_date" type="text" data-date-format="dd-mm-yyyy" value="{{$exp_date or ''}}">
																		<span class="input-group-addon">
																			<i class="fa fa-calendar bigger-110"></i>
																		</span>
																	</div>
															...
															<div id="txt_pwd" class="col-xs-12 col-sm-12 col-lg-12 form-group {{$hide}}">
																...
																<br />
																 <input class="form-control input-sm" type="text" name="pm_pwd" id="pm_pwd"   value="{{$pm_pwd or ''}}"/>
