...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class='table_header'>@lang('label.lb31')</div>
              ...
              <div class='table_small'>
               ...
               <div class='table_small'>          
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.lb31')</div>
                    <div class='table_cell'>
                      <select class="form-control input-sm" name="branch_id[]" data-placeholder="@lang('label.lb31')...">
