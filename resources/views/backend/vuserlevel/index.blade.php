				...
				<form action="" method="get" id="filter">
				    ...
				    <!--/--></div>
							...
							<div class="col-xs-12">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>@lang('label.lb20')</th>
														
														<th width="60" class="hidden-480">@lang('label.status')</th>

														<th width="65" class="width-480"></th>
													</tr>
												</thead>
														...
														<td>
															...
															@php
																...
																foreach($levelsetting as $setting)
																{
																	...
																	list($obj, $method) = explode('-',$setting);
                              ...
                              @php
                                $ind=0;
                                $arr_badge=['badge-success', 'badge-warning']
                              @endphp
																@foreach($objarr as $obj => $method)
																	@php
                                    $ind++;
																		$obj_title = $definelevel[$obj]['title'];
                                    
																	@endphp
																	<span class="badge badge-info w100" style="text-align: left; margin-bottom: 3px;">
																		<span class="badge {{$arr_badge[$ind%2]}}" style="text-align: left; width:150px; font-weight:bold">{{$obj_title}}</span>
																		&nbsp;
																		{{implode(", ", $method)}}
																	</span>
