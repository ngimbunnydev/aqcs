	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<div class="tablediv" id="results">
            <div class='theader'>
			  ...
			  <div class='table_header'>Parent</div>
			  <div class='table_header'>Ordering</div>
			  <div class='table_header'>Pic</div>
            ...
            <div class='table_row'>
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>Parent</div>
					<div class='table_cell'>
						<select class="en label_b form-control input-sm" name="parent_id[]">
							...
							@php
								...
								$disable = isset(${$fprimarykey}[$i])?${$fprimarykey}[$i]:0;
							@endphp

							{!!cmb_listing($parents,$select,$disable,'')!!} 
						</select>
					</div>          
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>Ordering</div>
					<div class='table_cell'>
