	...
	<script type="text/javascript">
		...
		var updateNestableDatalist = function(e)
        {
            ...
            if (window.JSON) {
                ...
                airWindows('', {ajaxpath:'ajax_obj', objpath:'', ajaxobj:'attribute', ajaxact:'editlist', listdata: listdata, parent_id:'{{${$fprimarykey ?? ''} ?? '-1'}}'},'','title',false);
																		...
																		<div class="panel-collapse collapse" id="collapse{{$element['id']}}">
																			<div class="panel-body pding-5">
																				...
																				@if (!empty($element['children']))
																					...
																					@include('backend.vattribute.nest', $datalist)
																				@endif
