...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<div class="">
			<label class="frm-label" for="formname">Form Name<span class="red">*</span></label>	
			<input type="text" class="form-control input-sm" name="formname" id="formname" value="{{ $formname ?? '' }}">
