	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<div class="tablediv" id="results">
            <div class='theader'>
              ...
              <div class='table_header'>@lang('label.code')</div>
			  <div class='table_header'>@lang('label.lb118')</div>
			  <div class='table_header'>@lang('label.lb119')</div>
			  <div class='table_header'>@lang('label.display')</div>
       ...
       <div class='table_small'>
                    ...
                    <div class='table_cell'>Code</div>
					<div class='table_cell'>
						<input type="text" class="en label_b form-control input-sm" name="code[]" value="{{ $code[$i]??'' }}" placeholder="Enter Code">
					</div>          
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.lb118')</div>
					<div class='table_cell'>
						<select class="en label_b form-control input-sm" name="parent_id[]">
							<option>-- {{__('ccms.ps')}} --</option>
							@php
								$select= isset($parent_id[$i])?[$parent_id[$i]]:[];
							@endphp
							{!!CategorySelectboxTree($cat_tree,"","",$select,'location_id') !!}
						</select>
					</div>          
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.lb119')</div>
					<div class='table_cell'>
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.display')</div>
					<div class='table_cell'>
						<select class="en label_b form-control input-sm" name="display[]">
							{!!cmb_listing(['yes'=>'Yes','no'=>'No'],[$display[$i]??''],'','')!!} 
						</select>
					</div>          
                ...
                <div class='table_small'>
					...
					<div class='table_cell'>
						<div class="input-group">
                                <input class="form-control input-sm" type="text" name="image[]" id="image" value="{{ $image[$i] ?? '' }}" readonly="readonly" ondblclick="this.value=''"/>
...
<!-- write for cloen-->
            <div class='table_row hide' id='recordTemplate'>
			    <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.title')</div>
					<div class='table_cell'>
              ...
              <div class='table_small'>
                    ...
                    <div class='table_cell'>Code</div>
					<div class='table_cell'>
						<input type="text" class="en label_b form-control input-sm" name="code[]" placeholder="Enter Code">
					</div>          
                ...
                <div class='table_small'>
					...
					<div class='table_cell'>
						<select class="en label_b form-control input-sm" name="parent_id[]">
							<option>-- {{__('ccms.ps')}} --</option>
							{!!CategorySelectboxTree($cat_tree,"","",[], "location_id") !!}
						</select>
					</div>          
                ...
                <div class='table_small'>
					...
					<div class='table_cell'>
						<div class="input-group">
                                <input class="form-control input-sm" type="text" name="image[]" id="image" value="" readonly="readonly" ondblclick="this.value=''"/>
                                <span class="input-group-btn">
