...
@endphp
          ...
          <!--     Location        -->
			...
			{{-- Report --}}
			<li class="{{nav_checkactive(['reportaqi','livedata','reportdatetime', 'reportlocation','reportbranch'],$obj_info['name'],'open')}}">
				<a href="#" class="dropdown-toggle">
				...
				<ul class="submenu">
					...
					<li class="showhidemenu {{nav_checkactive(['reportaqi'],$obj_info['name'])}}">
						<a href="{{ url_builder('admin.controller',['reportaqi']) }}">
							<i class="menu-icon"><i class="fa fa-caret-right"></i></i>
							AQI
						</a>
