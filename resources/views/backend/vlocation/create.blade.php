	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<div class="tablediv" id="results">
            <div class='theader'>
			  ...
			  <div class='table_header'>Latitude Longitude</div>
        	  <div class='table_header'>@lang('label.lb13')</div>
            ...
            <div class='table_row'>
              ...
              <div class='table_small'>
               ...
               <div class='table_small'>
                   ...
                   <div class='table_cell'>@lang('label.code')</div>
                  <div class='table_cell'>
			   ...
			   <div class='table_small'>
				...
				<div class='table_cell'>Latitude Longitude</div>
			   <div class='table_cell'>
				 <input type="text" class="form-control input-sm" name="latlong[]" id="latlong" placeholder="" value="{{$latlong[$i] ?? '' }}">
			   </div>          
                ...
                <div class='table_small'>
                    ...
                    <div class='table_cell'>@lang('label.lb13')</div>
                    <div class='table_cell'>
                      <select class="form-control input-sm" name="branch_id[]" data-placeholder="@lang('label.lb13')...">
                      {!!cmb_listing($branch,[$branch_id[$i] ?? 0],
                                                '','')
                                                !!} 
                      </select>
                    </div>          
...
<div class='table_row hide' id='recordTemplate'>
  ...
  <div class='table_small'>                     
    <div class='table_cell'>Latitude Longitude</div>
    <div class='table_cell'>
      <input type="text" class="form-control input-sm" name="latlong[]" id="latlong" placeholder="" value="">
    </div>                                    
  </div><!-- /.cell -->
