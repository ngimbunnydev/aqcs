	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		...
		<div class="tablediv" id="results">
            <div class='theader'>
			  ...
			  <div class='table_header'>Caption <span class="red">*</span></div>
			    ...
			    <div class='table_small'>
					...
					<div class='table_cell'>
						...
						<div class="input-group" style="width:100%;"> 
	            			...
	            			<select id="tab_title" class="form-control input-sm" style="width:15%;">
	                        @foreach (config('ccms.multilang') as $lang)
	                    	...
	                    	@php ($active = '') @endphp
	                    	@foreach (config('ccms.multilang') as $lang)
	                    	<input type="text" class="form-control input-sm {{$active}}" style="width:85%;" name="title-{{$lang[0]}}[]" id="title-{{$lang[0]}}" placeholder="{{$lang[1]}}" value="{{ ${'title-'.$lang[0]}[$i] ?? '' }}">
...
<!-- write for cloen-->
            <div class='table_row hide' id='recordTemplate'>
			    <div class='table_small'>
                    ...
                    <div class='table_cell'>Caption</div>
					<div class='table_cell'>
						...
						<div class="input-group my-group" style="width:100%;"> 
	                    	...
	                    	@php ($active = '') @endphp
	                    	@foreach (config('ccms.multilang') as $lang)
	                    	<input type="text" class="form-control input-sm {{$active}}" style="width:85%;" name="title-{{$lang[0]}}[]" id="title-{{$lang[0]}}" placeholder="{{$lang[1]}}" value="">
	                    	@php ($active = 'hide') @endphp
	                    	@endforeach
