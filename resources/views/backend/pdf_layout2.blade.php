...
<html lang="en">
	<head>
		...
		<style type="text/css">
			...
			.rowtitle{
				float: left; width: 0; text-align: right; border: 0px solid red;
			}

			.rowvalue{
				float: left; width: 100%; border: 0px solid blue; text-align: right;
			}
	...
	<body class="no-skin">
      ...
      <div id="header-wrapper-info">
                <div style="float:left; width:100%;">
                                ...
                                <div class="rowvalue">
                                  <h5 class="mg-0" id="header-title">{{$header_contact_info['nativename']}}</h5> 

                                </div>

               </div><!--a row-->
               @if(!empty($header_contact_info['vat']))
                <div style="float:left; width:100%;">


                                <div class="rowvalue">
                                  លេខអត្តសញ្ញាណកម្ម អតប: {{$header_contact_info['vat']}}
              ...
              <div style="float:left; width:100%;">
                                  ...
                                  <div class="rowvalue">
                                      ...
                                      Phone: {{$header_contact_info['phone']}}
