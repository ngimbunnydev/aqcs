...
var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.addToolbarButtons = function () {
        ...
        /*bunny*/
        this.context.memo('button.widget', function () {
            return _this.button({
                contents: _this.ui.icon(_this.options.icons.widget),
                tooltip: 'widget',
                click: _this.context.createInvokeHandler('widgetDialog.show')
            }).render();
        });
        /**/
 ...
 */
 var ImageTest = /** @class */ (function () {
    ...
    ImageDialog.prototype.show = function () {
        var _this = this;
        this.context.invoke('editor.saveRange');
        this.context.invoke('editor.insertText', ''); /*just for hide air toolbar*/
        
        filemanagerSetting.displaymode=3;
	    filemanagerSetting.filetype='image';
        editorContext=this.context;
        
	    var categoryid=$('#filecategory').val();
 ...
 var WidgetDialog = /** @class */ (function () {
    ...
    WidgetDialog.prototype.show = function () {
        var _this = this;
        this.context.invoke('editor.saveRange');
        this.context.invoke('editor.insertText', ''); /*just for hide air toolbar*/
     ...
     * @return {Promise}
     */
    WidgetDialog.prototype.showWidgetDialog = function () {
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        popover: {
            ...
            air: [
        ['style', ['style']],
        ['font', ['bold', 'underline','italic','superscript','subscript','strikethrough', 'clear']],
        ['fontname', ['fontname','fontsize']],
        ['color', ['color']],
        ['para', ['ul', 'ol', 'paragraph']],
        ['table', ['table']],
        ['insert', ['link', 'picture', 'video','widget']] /****bunny*/
      ]
        },
